<?php
	...
	class emp{}
	if(isset($_POST["id"]) && isset($_POST["image"]) && isset($_POST["nama"]) && isset($_POST["information"])){
    	$id = validate($_POST["id"]);
    	$image = validate($_POST["image"]);
    	$namauser = validate($_POST["nama"]);
    	...
    	if (empty($information)) { 
    		...
    		$nama = "close_up1";
    		$path = "upload_image/".$namauser."_closeup1.jpg";
    		
    		// sesuiakan ip address laptop/pc atau URL server
    		$format = ".jpg";
    		$actualpath = "".$namauser."_closeup1.jpg";
